...
namespace WebApiObjetos.Services
{
    ...
    public class UserService : IUserService
    {
        ...
        public async Task DeleteUser(LoginDTO user)
        {
            /*
            int id = 1;
            ...
            */
            ...
            await userRepo.Delete(result); // se podria tener todo en la misma linea pero se pierde legibilidad
        }
        ...
        public async Task<bool> SignIn(UserDTO user)
        {
            ...
            var exitinUser = userRepo.FindBy(x => x.UserName == "sasa"); /// probar si funciona.
        ...
        public async Task<UserDTO> RefreshTokens(string token, string refreshToken)
        {
            ...
            userRepo.SaveRefreshToken(username, newRefreshToken); //idem
        ...
        private JwtSecurityToken GenerateToken(UserDTO user)
        {
            ...
            return new JwtSecurityToken(
                        ...
                        claims: (IEnumerable<Claim>)claim,
